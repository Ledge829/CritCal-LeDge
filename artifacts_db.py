"""
Comprehensive artifact set database for CritCal's smart scoring engine.

Every artifact set with 2pc/4pc bonuses, synergy tags, and domain source.
Powers CritCal's ability to evaluate gear synergy beyond curated lists.
"""

ARTIFACTS_DB = {
    # ================================================================
    # ADVENTURER / BASIC SETS (early game)
    # ================================================================
    "adventurer": {
    ...
    # ================================================================
    # STANDARD 4-STAR / EARLY DOMAIN SETS
    # ================================================================
    "archaic petra": {
    ...
    "severed fate": {  # alias for Emblem of Severed Fate
        "bonus_2pc": "Energy Recharge +20%.",
        "bonus_4pc": "Increases Elemental Burst DMG by 25% of Energy Recharge (max 75%).",
        "tags": ["er", "burst_dmg", "universal"],
    },
    ...
    # ================================================================
    # NEWER DOMAIN SETS (Inazuma onwards)
    # ================================================================
    "blizzard strayer": {
    ...
    "emblem of severed fate": {  # duplicate - keep the one above
        "bonus_2pc": "Energy Recharge +20%.",
        "bonus_4pc": "Increases Elemental Burst DMG by 25% of Energy Recharge (max 75%).",
        "tags": ["er", "burst_dmg", "universal"],
    },
    ...
    "lost paradise": {  # Flower of Paradise Lost
        "bonus_2pc": "Elemental Mastery +80.",
        "bonus_4pc": "Bloom, Hyperbloom, and Burgeon DMG increased by 40%. Each stack adds 25% more (max 4).",
        "tags": ["em", "bloom", "hyperbloom", "burgeon"],
    },
    "marechaussee hunter": {
...
for dup in ["severed fate", "lost paradise", "emblem of severed fate"]:
    if dup in ARTIFACTS_DB:
        ARTIFACTS_DB.pop(dup)

# Unique entries
ARTIFACTS_DB["emblem of severed fate"] = {
    "bonus_2pc": "Energy Recharge +20%.",
    "bonus_4pc": "Increases Elemental Burst DMG by 25% of Energy Recharge (max 75%).",
    "tags": ["er", "burst_dmg", "universal"],
}

...
# ==========================================================
    ...
    "bis_weapon": "Elegy for the End",
    "secondary_weapon": "Favonius Warbow",
    "f2p_weapon": ["Favonius Warbow", "Sacrificial Bow", "Prototype Crescent", "Hamayumi", "Song of Stillness"],
    "niche_weapon": [],
    },
    "amber": {
    "bis_weapon": "Aqua Simulacra",
    ...
    "bis_weapon": "Freedom-Sworn",
    "secondary_weapon": "Favonius Sword",
    "f2p_weapon": ["Favonius Sword", "Sacrificial Sword", "Amenoma Kageuchi", "Sapwood Blade", "Iron Sting"],
    "niche_weapon": [],
    },
    "ayato": {
    ...
    "f2p_weapon": ["Favonius Codex", "Sacrificial Fragments", "Mappa Mare", "Prototype Amber", "The Widsith"],
    "niche_weapon": [],
    },
    "dendrotraveler": {
    "bis_weapon": "Freedom-Sworn",
    ...
    "bis_weapon": "Staff of the Scarlet Sands",
    "secondary_weapon": "Staff of Homa",
    "f2p_weapon": ["Favonius Lance", "The Catch", "Kitain Cross Spear", "Missive Windspear", "Prospector's Shovel", "Prototype Starglitter"],
    "niche_weapon": [],
    },
    "geotraveler": {
    "bis_weapon": "Favonius Sword",
    ...
    "bis_weapon": "Staff of Homa",
    "secondary_weapon": "Favonius Lance",
    "f2p_weapon": ["Favonius Lance", "The Catch", "Kitain Cross Spear", "Missive Windspear", "Prototype Starglitter"],
    "niche_weapon": [],
    },
    "ineffa": {
    "bis_weapon": "Engulfing Lightning",
    ...
    "f2p_weapon": ["Favonius Greatsword", "Sacrificial Greatsword", "Prototype Archaic", "Tidal Shadow", "Mailed Flower"],
    "niche_weapon": [],
    },
    "pyrotraveler": {
    "bis_weapon": "Favonius Sword",
